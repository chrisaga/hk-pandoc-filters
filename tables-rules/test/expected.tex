...
\begin{longtable}[]{@{\extracolsep{-\arrayrulewidth}}|
  >{\centering\arraybackslash}p{(\columnwidth - 8\tabcolsep - 3\arrayrulewidth) * \real{0.1667}}|
  >{\raggedright\arraybackslash}p{(\columnwidth - 8\tabcolsep - 3\arrayrulewidth) * \real{0.1111}}|
  >{\raggedleft\arraybackslash}p{(\columnwidth - 8\tabcolsep - 3\arrayrulewidth) * \real{0.2222}}|
  >{\raggedright\arraybackslash}p{(\columnwidth - 8\tabcolsep - 3\arrayrulewidth) * \real{0.3611}}|}
...
\begin{longtable}[]{@{\extracolsep{-\arrayrulewidth}}|
  >{\raggedright\arraybackslash}p{(\columnwidth - 6\tabcolsep - 2\arrayrulewidth) * \real{0.2222}}|
  >{\raggedright\arraybackslash}p{(\columnwidth - 6\tabcolsep - 2\arrayrulewidth) * \real{0.2222}}|
  >{\raggedright\arraybackslash}p{(\columnwidth - 6\tabcolsep - 2\arrayrulewidth) * \real{0.2917}}|}

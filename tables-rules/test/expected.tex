...
\begin{longtable}[]{|
  >{\centering\arraybackslash}p{(\columnwidth - 8\tabcolsep - 5\arrayrulewidth) * \real{0.1667}}|
  >{\raggedright\arraybackslash}p{(\columnwidth - 8\tabcolsep - 5\arrayrulewidth) * \real{0.1111}}|
  >{\raggedleft\arraybackslash}p{(\columnwidth - 8\tabcolsep - 5\arrayrulewidth) * \real{0.2222}}|
  >{\raggedright\arraybackslash}p{(\columnwidth - 8\tabcolsep - 5\arrayrulewidth) * \real{0.3611}}|}
...
\begin{longtable}[]{|
  >{\raggedright\arraybackslash}p{(\columnwidth - 6\tabcolsep - 4\arrayrulewidth) * \real{0.2222}}|
  >{\raggedright\arraybackslash}p{(\columnwidth - 6\tabcolsep - 4\arrayrulewidth) * \real{0.2222}}|
  >{\raggedright\arraybackslash}p{(\columnwidth - 6\tabcolsep - 4\arrayrulewidth) * \real{0.2917}}|}
